              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-dark">
                    {order.revenue.toLocaleString('ru-KZ', { maximumFractionDigits: 0 })}{cs}
                  </p>
            ...
            <button key={p.product_id} className="w-full text-left bg-white rounded-[12px] p-4 shadow-sm" onClick={() => navigate(`/revenue/products/${p.product_id}`)}>
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-sm font-semibold text-dark">{p.total_revenue.toLocaleString('ru-KZ', { maximumFractionDigits: 0 })}{cs}</p>
